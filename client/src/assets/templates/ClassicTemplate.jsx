...
const ClassicTemplate = ({ data, accentColor }) => {
  ...
  return (
    <div className="template-div max-w-4xl mx-auto p-8 bg-white text-gray-800 leading-relaxed">
      {/* Header */}
      <header
      ...
      {data.project && data.project.length > 0 && (
        <section className="mb-6">
          ...
          <ul className="space-y-3 list-disc list-inside text-justify text-sm text-zinc-700 leading-snug break-all whitespace-pre-wrap overflow-x-hidden">
