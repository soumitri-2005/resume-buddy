    ...
    <div className="template-div max-w-4xl mx-auto p-8 bg-white text-gray-900 font-light">
      ...
      {data.professional_summary && (
        <section className="mb-7">
          <p className="text-gray-700 leading-snug text-justify whitespace-pre-wrap break-words overflow-x-hidden">
            {data.professional_summary}
          </p>
        </section>
      )}
          ...
          <div className="space-y-4">
            {data.project.map((proj, index) => (
              ...
              >
                ...
                <p className="text-justify text-sm text-zinc-700 leading-snug space-y-1 break-all whitespace-pre-wrap overflow-x-hidden">{proj.description}</p>
              </div>
            ))}
          </div>
        </section>
