  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-1 text-sm text-white bg-gradient-to-br from-purple-600 to-[var(--highlight-color)] ring-purple-300 hover:ring transition-all px-3 py-2 rounded-2xl"
      >
        <Palette size={16} />
        ...
        <div className="grid grid-cols-4 w-60 gap-2 absolute top-full left-0 right-0 p-3 mt-2 z-10 bg-white rounded-md border border-gray-200 shadow-sm">
          {colors.map((color) => (
            <div
              ...
              className="relative cursor-pointer froup flex flex-col"
            >
              <div
